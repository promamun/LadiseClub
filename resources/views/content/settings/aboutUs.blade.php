                                ...
                                <div class="row mb-3">
                                    <div class="col">
                                        ...
                                        <input type="text" class="form-control" id="name" placeholder="Name Here"
                                            value="{{ old('name',$aboutUs->name ?? '') }}" name="name" aria-label="Name Here">
                                    </div>
                                    <div class="col">
                                        <label class="form-label" for="title">Title</label><span
                                            class="text-danger">*</span>
                                        <input type="text" class="form-control" id="title" placeholder="Title Here"
                                            value="{{ old('title',$aboutUs->title ?? '') }}" name="title" aria-label="Title Here">
                                    </div>
                                </div>
                                ...
                                <div class="row input__group mb-25">
                                  ...
                                  <div class="col-lg-4">
                                    <div class="upload-img-box">
                                      ...
                                      @else
                                          <img src="{{ asset('aboutUs/default_about.png') }}" alt="Default About Us Image">
                                      @endif
                                      <input type="file" name="image" id="sign_up_left_image" accept="image/*" onchange="previewFile(this)">
                                      ...
                                      @endif
                                      <p><span class="text-black">{{ __('Accepted Files') }}:</span> PNG, Image,Jpeg <br> <span class="text-black">{{ __('Recommend Size') }}:</span> 817 x 732 (1MB)</p>
                                  </div>
                              </div>
