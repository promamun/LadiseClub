...
@section('title', 'Update Facilitie Detail')
    ...
    <div class="app-ecommerce">
        ...
        <div class="row">
            ...
            <div class="col-12 col-lg-12">
                ...
                <!-- Product Information -->
                <div class="card mb-4">
                    <form action="{{ route('facilitieDetail.update', $data->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row mb-3">
                                <div class="col">
                                    <img width="100" src="{{ asset('facilitieDetail/' . $data->image) }}" alt="img">
                                </div>
                            </div>
