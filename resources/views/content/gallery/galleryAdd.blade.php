...
@section('page-script')
  ...
  <script>
    document.addEventListener('DOMContentLoaded', function() {
      ...
      selectGallery.addEventListener('change', function() {
        if (this.value === 'Photo') {
      ...
      selectGallery.dispatchEvent(new Event('change'));
    });
  </script>
@endsection
@section('content')
  ...
  <div class="app-ecommerce">
    ...
    <div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center mb-3">
      ...
      <div class="d-flex flex-column justify-content-center">
        <h4 class="mb-1 mt-3">Add a new Gallery</h4>
      </div>
            ...
            <div class="card-body">
              <div class="row mb-3">
                <div class="col-md-12 mb-4">
                  <label for="select2Multiple" class="form-label">Select Gallery</label><span
                    class="text-danger">*</span>
                  <select id="select2Multiple" name="key" class="select2 form-select" required>
                    <option value="Photo" {{ (collect(old('key'))) ? 'selected' : '' }}>Photo Gallery</option>
                    <option value="Video" {{ (collect(old('key'))) ? 'selected' : '' }}>Video Gallery</option>
                  </select>
                </div>
              </div>
              ...
              <div class="row mb-3" id="videoInputContainer" style="display: none;">
                <div class="col">
                  ...
                  <input type="text" class="form-control" id="video" placeholder="YouTube embed URL Here"
                         name="value">
                </div>
              </div>
