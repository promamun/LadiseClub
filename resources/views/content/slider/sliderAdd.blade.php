      ...
      <div class="col-sm-12">
        ...
        <div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center mb-3">
            ...
            <div class="d-flex flex-column justify-content-center">
                <h4 class="mb-1 mt-3">Add a new Slider </h4>
            </div>
              ...
              <div class="col-sm-12">
                ...
                <div class="card mb-4">
                    <form action="{{ route('slider.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="card-body">
                          <div class="col">
                            <label class="form-label" for="name">Image</label><span class="text-danger">*</span><span class="text-warning"> 1920*600</span>
                        ...
                        <div class="pt-4 mb-3 float-lg-end">
                            <button class="btn btn-primary me-sm-3 me-1 waves-effect waves-light">Add Slider </button>
                        </div>
                    </form>
                </div>
                <!-- /Product Information -->
