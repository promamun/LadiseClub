                    ...
                    <div class="card-body">
                        ...
                        <div class="row mb-3">
                          <div class="col">
                              ...
                              <input type="text" class="form-control" id="description" placeholder="Description Here" value="{{ old('description')?? $data->description }}" name="description" aria-label="description Here">
                          </div>
                          <div class="col">
                              <label class="form-label" for="short_description">Short Description</label><span class="text-info">(optional)</span>
                              <input type="text" class="form-control" id="short_description" placeholder="Short Description Here" value="{{ old('short_description')?? $data->short_description }}" name="short_description" aria-label="short_description Here">
                          </div>
                        </div>
                        <div class="row mb-3">
                          <div class="col">
