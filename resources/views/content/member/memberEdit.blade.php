      ...
      <div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center mb-3">
        ...
        <div class="d-flex align-content-center flex-wrap gap-3">
          <a href="{{ route('member-list') }}">
            <button type="submit" class="btn btn-primary">Member
              List
            </button>
          </a>
        </div>
            ...
            <form action="{{ route('member.update', $data->id) }}" method="POST" enctype="multipart/form-data">
              ...
              <div class="card-body">
                <div class="row mb-3">
                  ...
                  <div class="col-md-6 mb-4">
                    ...
                    <select id="select2Multiple" name="category_id[]" class="select2 form-select"
                            multiple required>
                ...
                <div class="row mb-3">
                  <div class="col">
                    ...
                    <input type="text" class="form-control" id="member_id" placeholder="Id Here"
                           value="{{ old('member_id') ?? $data->member_id }}" name="member_id"
                           aria-label="member_id">
                  </div>
                  <div class="col">
                ...
                <div class="row mb-3">
                  ...
                  <div class="col">
                    ...
                    <div class="input-group">
                      <input type="tel" value="{{ old('phone', $data->phone) }}" name="phone" class="form-control" aria-label="Text input with checkbox">
                      <div class="input-group-text">
                        <input class="form-check-input mt-0"
                          ...
                          {{ old('phone_is_active', $data->phone_is_active) ? 'checked' : '' }}>
                ...
                <div class="row mb-3">
                  <div class="col">
                    ...
                    <input type="number" class="form-control" id="mobile"
                           placeholder="mobile Here" value="{{ old('mobile') ?? $data->mobile }}"
                ...
                <div class="row mb-3">
                  <div class="col">
                    ...
                    <input type="text" class="form-control" id="twitter"
                           placeholder="twitter Here" value="{{ old('twitter') ?? $data->twitter }}"
                           name="twitter" aria-label="twitter">
                  </div>
                  <div class="col">
                ...
                <div class="row mb-3">
                  <div class="col">
                    <label class="form-label" for="instagram">Instagram</label><span
                      class="text-info">
                                            (optional)</span>
                    <input type="text" class="form-control" id="instagram"
                           placeholder="instagram Here"
                           value="{{ old('instagram') ?? $data->instagram }}" name="instagram"
                ...
                <div class="row mb-3">
                  ...
                  <div class="col">
                    <label class="form-label" for="company_name">Company Name</label><span
                      class="text-info">
                                        (optional)</span>
                    <input type="text" class="form-control" id="company_name"
                           placeholder="Company Nname Here"
                ...
                <div class="col-12">
                  ...
                  <textarea id="bootstrap-maxlength-example2" name="descripton"
              ...
              <div>
                <div class="pt-4 mb-3 float-lg-end">
                  <button type="submit"
                          class="btn btn-primary me-sm-3 me-1 waves-effect waves-light">Update
                  </button>
                </div>
              </div>
            </form>
