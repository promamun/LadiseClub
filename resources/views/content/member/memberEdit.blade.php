                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col">
                                    ...
                                    <input type="text" class="form-control" id="facebook" placeholder="facebook Here"
                                        value="{{ old('facebook')?? $data->facebook }}" name="facebook" aria-label="facebook">
                                </div>
                            </div>
                            <div class="row mb-3">
                                <div class="col">
                                    ...
                                    <input type="text" class="form-control" id="twitter" placeholder="twitter Here"
                                        value="{{ old('twitter')?? $data->twitter }}" name="twitter" aria-label="twitter">
                                </div>
                                <div class="col">
                                    ...
                                    <input type="text" class="form-control" id="linkedin" placeholder="linkedin Here"
                                        value="{{ old('linkedin')?? $data->linkedin }}" name="linkedin" aria-label="linkedin">
                                </div>
                            </div>
                            <div class="row mb-3">
                                <div class="col">
                                    ...
                                    <input type="text" class="form-control" id="instagram"
                                        placeholder="instagram Here" value="{{ old('instagram')?? $data->instagram }}" name="instagram"
                                ...
                                <div class="col">
                                    ...
                                    <input type="text" class="form-control" id="personal_website"
                                        placeholder="personal_website Here" value="{{ old('personal_website')?? $data->personal_website }}"
