                    ...
                    <form action="{{ route('member.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col">
                                    <label class="form-label" for="mobail">Mobail</label><span class="text-info">
                                        (optional)</span>
                                    <input type="number" class="form-control" id="mobail" placeholder="Mobail Here"
                                        value="{{ old('mobail') }}" name="mobail" aria-label="mobail">
                                </div>
                            </div>
                            <div class="row mb-3">
                                <div class="col">
                            ...
                            <div class="row mb-3">
                                <div class="col">
                                    <label class="form-label" for="twiter">Twiter</label><span class="text-info">
                                        (optional)</span>
                                    <input type="text" class="form-control" id="twiter" placeholder="twiter Here"
                                        value="{{ old('twiter') }}" name="twiter" aria-label="twiter">
                                </div>
                                <div class="col">
                                    <label class="form-label" for="linkdin">Linkdin</label><span class="text-info">
                                        (optional)</span>
                                    <input type="text" class="form-control" id="linkdin" placeholder="linkdin Here"
                                        value="{{ old('linkdin') }}" name="linkdin" aria-label="linkdin">
                                </div>
                            </div>
                            <div class="row mb-3">
                                <div class="col">
